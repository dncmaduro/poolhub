...
const MarkerIconWrapper = dynamic(() => import('./LeafletMarker/MarkerIconWrapper'))
        ...
        <div className="flex flex-row justify-center pt-3" style={{ width: '300px' }}>
          ...
          >
            ...
            <div className="mt-6 flex flex-row justify-between gap-2 p-2">
              <Button className="gap-2 bg-secondary text-white" onClick={() => handlePopupClose()} size='sm'>
                <ChevronLeft size={AppConfig.ui.menuIconSize} />
                Close
              </Button>
              <Button className="gap-2 bg-primary text-white" onClick={() => handleOpenLocation()} size='sm'>
                Open
